...
import com.tuepoo.core.video.VideoAdContext;
import com.tuepoo.module.news.NewsHeaderValue;
...
public class NewsDetailHeaderView extends RelativeLayout {
     ...
     * data
     */
    private NewsHeaderValue mData;
    private ImageLoaderUtil mImageLoader;

    public NewsDetailHeaderView(Context context, NewsHeaderValue value) {
        this(context, null, value);
    }

    public NewsDetailHeaderView(Context context, AttributeSet attrs, NewsHeaderValue value) {
        super(context, attrs);
        mContext = context;
        mData = value;
    ...
    private void initView() {
        mRootView = (RelativeLayout) LayoutInflater.from(mContext).
                inflate(R.layout.listview_new_comment_head_layout, this);

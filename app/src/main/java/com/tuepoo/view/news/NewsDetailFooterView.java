...
import com.tuepoo.R;
import com.tuepoo.activity.NewsDetailActivity;
import com.tuepoo.module.news.NewsFooterDateValue;
import com.tuepoo.module.news.NewsFooterRecommandValue;
import com.tuepoo.module.news.NewsFooterValue;
import com.tuepoo.util.DateFormatHelper;
import com.tuepoo.adutil.ImageLoaderUtil;

import java.util.ArrayList;


public class NewsDetailFooterView extends RelativeLayout {
    ...
    private NewsFooterValue mFooterValue;

    public NewsDetailFooterView(Context context, NewsFooterValue footerValue) {
        this(context, null, footerValue);
    }

    public NewsDetailFooterView(Context context, AttributeSet attrs, NewsFooterValue footerValue) {
        super(context, attrs);
        mContext = context;
    ...
    private void initView() {
        ...
        mRootView = (RelativeLayout) inflater.inflate(R.layout.listview_new_comment_footer_layout, this);
        ...
        for (int i = 0; i < mFooterValue.recommand.size(); i++) {
            final NewsFooterRecommandValue value = mFooterValue.recommand.get(i);
            ...
            mImageViews[i].setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(NewsDetailActivity.COURSE_ID, value.courseId);
    ...
    private void addLineChartView() {
        ...
        for (int i = mFooterValue.time.size() - 1; i >= 0; i--) {
            if (mFooterValue.time.get(i) != null) {
                NewsFooterDateValue value = mFooterValue.time.get(i);

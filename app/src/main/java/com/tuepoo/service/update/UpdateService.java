package com.tuepoo.service.update;
...
public class UpdateService extends Service {
    ...
    private void notifyThatExceedLv21(String tickerMsg, String message, int progress) {
        ...
        notification.setSmallIcon(R.drawable.bg_message_app);
        notification.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.bg_message_app));
